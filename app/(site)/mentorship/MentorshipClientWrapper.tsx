...
interface MentorshipClientWrapperProps {
  initialComponents: ComponentSetting[];
}

export default function MentorshipClientWrapper({ initialComponents }: MentorshipClientWrapperProps) {
  ...
  useEffect(() => {
    ...
    const channel = supabase
      .channel('mentorship_components_changes')
      .on(
        'postgres_changes',
        {
          event: '*',
          schema: 'public',
          table: 'mentorship_components'
        },
        () => {
