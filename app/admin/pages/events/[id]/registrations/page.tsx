...
import { EventRegistrationsManager } from '@/components/admin/events/EventRegistrationsManager';
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: event ? `${event.title} - Registrations | Admin` : 'Event Registrations | Admin',
  };
}
