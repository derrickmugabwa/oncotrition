  ...
  return (
    <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-blue-50 via-indigo-50 to-white 
        dark:from-gray-900 dark:via-blue-900/20 dark:to-gray-900">
        {/* Radial gradient overlays */}
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_0%_0%,rgba(59,130,246,0.1),transparent_50%)]"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_100%_100%,rgba(99,102,241,0.1),transparent_50%)]"></div>
      ...
      <div className="relative container mx-auto px-6 text-center">
        ...
        >
          <motion.div
            ...
            className="inline-block px-4 py-1.5 mb-6 rounded-full border border-blue-600/30 bg-blue-600/10 backdrop-blur-sm"
          >
            <span className="text-sm text-blue-700 dark:text-blue-200 font-medium font-poppins">Get in Touch</span>
          </motion.div>
          ...
          <motion.p 
            ...
            className="text-xl md:text-2xl text-gray-700 dark:text-blue-100 mb-8 max-w-3xl mx-auto font-poppins"
          >
