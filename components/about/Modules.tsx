              ...
              return (
                ...
                >
                  ...
                  <div className="hidden md:flex relative items-center">
                    {/* Image */}
                    <div className={cn(
                      "w-[470px] h-[350px] rounded-3xl overflow-hidden bg-gray-200 dark:bg-neutral-800 flex-shrink-0",
                    ...
                    {/* Card */}
                    <div className={cn(
                      "bg-white dark:bg-card rounded-3xl shadow-2xl p-6 z-10 max-w-xl flex-1",
                      isImageRight ? "mr-[-80px] order-1" : "ml-[-80px] order-2"
                    )}>
                      <div className="mb-4">
                        <div className="inline-flex items-center justify-center p-3 bg-teal-100 dark:bg-teal-900/50 rounded-full mb-3">
                          {IconComponent && (
                            <IconComponent className="w-6 h-6 text-teal-600 dark:text-teal-400" />
                          )}
                        </div>
                        <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-3 font-outfit">
                          {module.title}
                        </h3>
                        <p className="text-base text-muted-foreground leading-relaxed mb-4 font-outfit">
