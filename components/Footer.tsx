    ...
    <footer className="bg-gradient-to-br from-gray-900 to-gray-800 text-gray-300">
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          >
            ...
            <p className="text-gray-400 leading-relaxed">
              Empowering your journey to better health through personalized nutrition guidance.
            </p>
          ...
          >
            ...
            <ul className="space-y-3">
              {contactInfo.map((info) => (
                <li key={info.label} className="flex items-start space-x-3 text-gray-400">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} Oncotrition. All rights reserved.</p>
...
const socialLinks = [
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/profile.php?id=61564768904026',
    icon: (
  ...
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/smart.spoon.plus/',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
